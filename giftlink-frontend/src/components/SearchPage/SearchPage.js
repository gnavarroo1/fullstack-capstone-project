...
function SearchPage() {
    ...
    const categories = ['', 'Kitchen', 'Office', 'Living', 'Bedroom', 'Office Furniture', 'Living Room'];
        ...
        <div className="container mt-5">
            <div className="row justify-content-center">
                <div className="col-md-6">
                    ...
                    <button className="btn btn-primary my-2 search-button" onClick={handleSearch}>Search</button>
